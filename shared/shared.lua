...
Shared.Event.addPlayerToRadio = ("%s:addPlayerToRadio"):format(Shared.currentResourceName)

Shared.Event.removePlayerFromRadio = ("%s:removePlayerFromRadio"):format(Shared.currentResourceName)
